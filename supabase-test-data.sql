...
('article-001', 'Bienvenue', 'Découvrez notre nouveau site d''information dédié à l''actualité internationale.', '<p>Votre source d''information de référence sur les événements mondiaux qui impactent le commerce maritime international.</p><p>Notre équipe de journalistes professionnels vous tient informé 24/7 des dernières actualités.</p>', 'Actualités', 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800', 'admin-001', 'Administrateur', 'https://ui-avatars.com/api/?name=Admin&background=3B82F6&color=fff', 'PUBLISHED', 150, NOW(), NOW()),
